	...
	<div class="container">
		<div class="row">
			<div class="col-md-12"> 
				...
				This holds true as well for links to green sites on webpages that you visit, which will be underlined subtly by a thin <a title="Example of link" href="#">green dashed line</a>.
				<br>
				<a class="cta">Download app</a>
			</div>
		</div>
	</div>
</div>